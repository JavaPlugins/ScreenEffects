...
public class GamemodeNMS_v1_19_R2 implements IGamemodeNMS
{
    Method method;
    {
        try
        {
            method = EntityHuman.class.getMethod("x"); // onUpdateAbilities() sends PacketPlayOutAbilities:
        }
        catch (NoSuchMethodException e)
        {
            System.err.println("Failed to load ScreenEffects for 1.19.3");
            e.printStackTrace();
        }
    }
