...
public class GamemodeNMS_v1_17_R1 implements IGamemodeNMS
{
    Method method;
    {
        try
        {
            method = EntityHuman.class.getMethod("updateAbilities");
        }
        catch (NoSuchMethodException e)
        {
            System.err.println("Failed to load ScreenEffects for 1.17.1");
            e.printStackTrace();
        }
    }
