...
public class GamemodeNMS_v1_20_6 implements IGamemodeNMS
{
    Method method;
    {
        try
        {
            // https://mappings.cephx.dev/1.20.6/net/minecraft/world/entity/player/Player.html
            method = EntityHuman.class.getMethod("y"); // onUpdateAbilities() sends PacketPlayOutAbilities.
        }
        catch (NoSuchMethodException e)
        {
            System.err.println("Failed to load ScreenEffects for 1.20.6");
            e.printStackTrace();
        }
    }
